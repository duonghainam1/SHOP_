        ...
        <header>
            <div>
                ...
                <div className="w-full flex justify-center items-center border-b">
                    <div className="lg:w-[1440px] lg:h-[76px] mb:h-[56px] flex justify-between *:flex *:items-center items-center">
                        {/* icon menu */}
                        ...
                        <img className="lg:translate-x-[64px] mb:translate-x-[-12.5px] lg:w-[167px] lg:h-[40px] mb:w-[119px] mb:h-[28px]" src={Logo} alt="" />
                        {/* form desktop */}
