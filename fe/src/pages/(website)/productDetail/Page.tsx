import Product_Image from './_components/Product_Image'
import Product_Detail from './_components/Product_Detail'
        ...
        <>
            <div>
                ...
                <main className="w-full *:lg:w-[1312px] *:w-[342px] *:mx-auto *:h-full lg:py-10 mb:py-6 lg:mt-0 mb:mt-0.5">
                    ...
                    {/* featured products */}
                    <div className="lg:mt-6 mb:-mt-1 lg:pt-[58px] mb:pt-[34px] mb-[200px]">
                ...
                <div className="show_img_product hidden top-12 absolute left-1/2 -translate-x-1/2 z-[1]">
                    <section className="lg:w-[800px] mb:min-w-[342px] flex flex-col gap-y-6 lg:items-center">
                        <div className="relative w-full lg:h-[520px] mb:min-h-[414px]  grid place-items-center bg-[#F2F6F4] rounded-3xl">
                            <img className="lg:w-[320px] lg:h-[320px] mb:w-[240px] mb:h-[240px]" src="../Images/img_product.png" alt="" />
                        ...
                        <div className="*:lg:w-16 *:lg:h-16 *:mb:w-14 *:mb:h-14 flex items-center gap-x-4 *:rounded-lg *:p-2 *:bg-[#F2F6F4] *:border-2 *:cursor-pointer *:duration-300">
                            <img className="border-[#17AF26]" src="../Images/img_product.png" alt="" />
                            <img className="hover:border-[#17AF26] border-[#F2F6F4]" src="../Images/img_product.png" alt="" />
                            <img className="hover:border-[#17AF26] border-[#F2F6F4]" src="../Images/img_product.png" alt="" />
                            <img className="hover:border-[#17AF26] w-[100px] h-[100px] border-[#F2F6F4]" src="../Images/img_product.png" alt="" />
                        </div>
                    </section>
                </div>
                {/* lớp phủ */}
                ...
                <div className="show_cart translate-x-[110%] duration-300 fixed lg:w-[41vw] mb:w-screen lg:rounded-none mb:rounded-3xl z-[1] lg:h-screen mb:h-[90vh] lg:top-0 mb:top-[10vh] right-0 bg-white py-8 mb:px-6 lg:px-8">
                    ...
                    <button className="close_cart absolute -translate-x-[200%] top-1/2 -translate-y-1/2">
                        <div className="relative w-10 h-10 rounded-[50%] bg-white duration-300 hover:scale-110"><img className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" src="../Images/arrow-right.png" alt="" />
                        </div>
                    </button>
                            ...
                            <div className="w-full flex flex-col gap-y-5 *:flex *:flex-col">
                                ...
                                <div className="hidden_scroll_y flex flex-col gap-y-5 overflow-y-scroll mt-5">
                                    ...
                                    <div className="flex gap-x-4 border-b pb-5">
                                        <img className="w-14 h-14 p-2 border rounded-xl" src="../Images/img_product.png" alt="" />
                                        <div className="w-full flex flex-col gap-y-5">
                                            <section className="w-full flex flex-col gap-y-1.5">
                                                ...
                                                <div className="w-full flex justify-between items-center">
                                                    <span className="flex gap-x-2 text-[#717378] font-light">2x<p className="font-normal">$120.00</p></span><p>$245.00</p>
                                                </div>
                                            </section>
                                            <section className="w-full flex flex-col gap-y-1.5">
                                                <strong className="flex lg:items-center mb:items-start font-normal justify-between text-[#060709]">Add Integra Pack - 4g<button className="w-6 h-6 rounded-[50%] border text-[#9D9EA2] font-light text-xs grid place-items-center">x</button>
                                                </strong>
                                                <div className="w-full flex justify-between items-center">
                                                    <span className="flex gap-x-2 text-[#717378] font-light">1x<p className="font-normal">$2.00</p></span><p>$2.00</p>
                                                </div>
                                            </section>
                                            <section className="w-full flex flex-col gap-y-1.5">
                                                <strong className="flex lg:items-center mb:items-start font-normal justify-between text-[#060709]">Add Integra Pack - 8g <button className="w-6 h-6 rounded-[50%] border text-[#9D9EA2] font-light text-xs grid place-items-center">x</button>
                                                </strong>
                                                <div className="w-full flex justify-between items-center">
                                                    <span className="flex gap-x-2 text-[#717378] font-light">1x<p className="font-normal">$3.00</p></span><p>$3.00</p>
                                                </div>
                                            </section>
                                    ...
                                    <div className="flex gap-x-4 border-b pb-5">
                                        ...
                                        <div className="w-full flex flex-col gap-y-5">
                                            <section className="w-full flex flex-col gap-y-1.5">
                                                <strong className="flex lg:items-center mb:items-start font-normal justify-between text-[#05422C]">Shipwreck Edibles Gummy <button className="w-6 h-6 rounded-[50%] border text-[#9D9EA2] font-light text-xs grid place-items-center">x</button>
                                                </strong>
                                                <div className="w-full flex justify-between items-center">
                                                    <span className="flex gap-x-2 text-[#717378] font-light">5x<p className="font-normal">$13.00</p></span><p>$65.00</p>
                                                </div>
                                            </section>
                                        </div>
                                    </div>
