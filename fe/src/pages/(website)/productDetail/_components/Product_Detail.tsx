...
import Comment_Products from './Comment_Products'
import Description from './Description'
import Refer_A_Friend from './Refer_A_Friend'
            ...
            <div className="h-full w-full *:w-full lg:mt-0 mb:mt-[42px]">
                <div className="flex flex-col lg:gap-y-5">
                    ...
                    <div className="lg:h-[211px] flex flex-col lg:gap-y-4">
                        ...
                        <strong className="lg:text-[32px] lg:mt-[1px] mb:mt-3.5 mb:text-[20px] lg:tracking-[-1.2px] font-medium lg:leading-[38.4px]">{data?.name}<br className="lg:block mb:hidden" />
                            (4 X 7G)</strong>
                        ...
                        <div className="flex lg:items-center mb:items-end justify-between">
                            <span className="font-medium text-[#EB2606] lg:text-xl lg:tracking-[0.7px] mb:text-base flex items-center lg:gap-x-3 lg:mt-0.5 mb:gap-x-2"><del className="font-light lg:text-sm mb:text-sm text-[#9D9EA2]">{data?.price}</del>$120.00</span>
                    ...
                    <div className="lg:h-[251px] border rounded-xl lg:px-6 lg:py-5 mb:px-5 mb:py-[20px] lg:my-0 mb:my-[18px]">
                        <div className="w-full h-full flex flex-col gap-y-5">
                            ...
                            <section className="flex gap-x-4">
                                <img className="w-8 h-8" src="../Images/colorfilter.png" alt="" />
                                <section className="flex flex-col lg:gap-y-[11px] lg:mt-0.5 mt-[2.5px] mb:gap-y-2.5 h-full">
                                    <span className="text-[#717378] text-xs tracking-[1px]">EFFECTS</span>
                                    <span className="text-[#060709] text-sm">Calming, Creative, Happy, Relaxing, Sleepy, Uplifting</span>
                                </section>
                            </section>
                            {/* item 1 */}
                            <section className="flex gap-x-4">
                                ...
                                <section className="flex flex-col lg:gap-y-[9px] lg:mt-0.5 mt-[3px] mb:gap-y-2 h-full justify-between">
                                    <span className="text-[#717378] text-xs tracking-[1px]">MAY RELIEVE</span>
                                    <span className="text-[#060709] text-[14px] lg:ml-0.5 tracking-[0.1px]">Anxiety, Arthritis, Chronic Pain, Depression, Fatigue,
                            ...
                            <section className="flex gap-x-4 lg:translate-y-1">
                                ...
                                <section className="flex flex-col lg:gap-y-[11px] lg:translate-y-[1px] lg:mt-0 mt-1 mb:gap-y-2.5 h-full justify-between">
                                    <span className="text-[#717378] text-xs tracking-[0.5px]">AROMAS</span>
                                    <span className="text-[#060709] text-sm">Chemical, Citrus, Earthy, Pungent, Sour</span>
                                </section>
                            </section>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col lg:gap-y-3 mb:gap-y-2 lg:mt-[2px] mt-[3px] lg:pb-0 mb:pb-[21px]">
                        <span className="text-xs tracking-[1px] text-[#717378]">DESCRIPTION</span>
                    ...
                    <div className="flex flex-col lg:gap-y-[22px] border-t lg:mt-[5px] lg:py-5 mb:py-6">
                        <div className="grid lg:grid-cols-[48.5%_48.5%] justify-between items-start">
                            <div className="*:text-xs flex flex-col gap-y-3 lg:mt-0 mb:-mt-1">
                                <span className="text-[#717378] lg:translate-y-0 mb:translate-y-1 tracking-[1px] uppercase">WEIGHT</span>
                                <section className="*:lg:px-[13.5px] *:lg:py-2.5 *:mb:px-3.5 *:mb:py-2 *:rounded flex gap-x-4 *:duration-200">
                                    <button className="hover:border border border-[#17AF26]">28g</button>
                                    <button className="hover:border-[#17AF26] border bg-[#F4F4F4] hover:bg-[#F3FBF4] border-[#F3FBF4]">1/2lb</button>
                                    <button className="hover:border-[#17AF26] border bg-[#F4F4F4] hover:bg-[#F3FBF4] border-[#F3FBF4]">1/4lb</button>
                                </section>
                            </div>
                            {/* ***** */}
                            <div className="flex flex-col lg:gap-y-4 gap-y-3 lg:mt-0 mb:mt-7">
                                <span className="text-[#717378] text-xs lg:tracking-[1px] tracking-[0.8px] uppercase">Add Integra Pack</span>
                                <section className="*:text-sm *:py-1 flex lg:gap-x-12 gap-x-14 *:duration-200">
                                    <div className="flex items-center *:lg:px-3.5 *:mb:px-2.5">
                                        <input className="rounded-lg w-[22px] h-[22px]" type="checkbox" />
                                        <span>4g (+$2.00)</span>
                                    </div>
                                    <span>8g (+$3.00)</span>
                                </section>
                    ...
                    {/* row 5 */}
                    <div className="lg:p-6 mb:py-5 mb:px-5 *:w-full border rounded-xl lg:-mt-5 -mt-1">
                        {/* price */}
                        <div className="flex flex-col gap-y-3.5 lg:pb-0 mb:pb-6 tracking-[-0.2px]">
                            <section className="flex justify-between *:font-medium *:text-sm">
                                <span className="flex gap-x-4 text-[#46494F]">Khalifa Kush (AAAA) <p className="text-[#9D9EA2]">2x</p></span>
                        ...
                        <section className="flex lg:mt-0 mt-0.5 flex-col pt-[23px] gap-y-[13px] *:flex *:items-center *:gap-x-2 *:lg:text-sm *:mb:text-xs *:text-[#46494F]">
                            <span>
                                ...
                                Free Xpress Shipping on orders over <p className="text-[#F2BC1B]">$149</p>
                            </span>
                            <span>
                                <img src="../Images/tick-circle.png" alt="" />
                    ...
                    <div className="grid lg:grid-cols-[49%_49%] justify-between lg:gap-y-0 mb:gap-y-4 lg:text-sm mb:text-xs *:flex border-t lg:pt-6 lg:mt-0 mb:pt-[18px] mb:mt-5 mb:grid-cols-full">
                        <span className="lg:gap-x-[84px] gap-x-[78px] font-light text-[#717378]">SKU <p className="font-normal text-[#060709]">:&nbsp;&nbsp;&nbsp; N/A</p>
                        </span>
                        <span className="font-light text-[#717378] lg:gap-x-[50px] mb:gap-x-10">Categories <p className="text-[#17AF26] font-normal">:&nbsp;&nbsp;&nbsp;&nbsp; AAAA Weed, Indica
                        </p></span>
                    </div>
                </div>
                {/* description */}
                <div className="flex flex-col border-t lg:py-10 lg:mt-10 mb:py-[34px] mb:mt-8">
                    ...
                    <ul className="flex items-center justify-between border-b lg:pb-6 mb:pb-5 *:lg:w-[197.33px] *:mb:w-[106px] *:lg:py-2.5 *:mb:py-[7px] *:rounded-[100px] *:border *:place-items-center *:lg:text-base *:mb:text-xs">
                        <button className="btn_show_description grid hover:border-[#05422C] border-[#05422C] text-[#05422C] hover:bg-[#F2F6F4] bg-[#F2F6F4]" onClick={() => setAction('description')}>Description</button>
                        <button className="btn_show_review flex items-center justify-center gap-x-1 hover:border-[#05422C] hover:text-[#05422C] hover:bg-[#F2F6F4]" onClick={() => setAction('reviews')}>Reviews
                            <p>(350)</p>
                        </button>
                        <button className="btn_show_refer grid hover:border-[#05422C] hover:text-[#05422C] hover:bg-[#F2F6F4]" onClick={() => setAction('refer')}>Refer a
                            Friend</button>
                    </ul>
                    {/* text description */}
                    ...
                    <section className="show_review ">
                        <div className="flex flex-col text-sm text-[#46494F] leading-[21px] gap-y-4 lg:pt-6 mb:pt-5 mb:pb-0">
                            {action === 'reviews' && <Comment_Products />}
                        </div>
                    </section>
                    {/* detail refer a friend */}
                    <div className="show_refer ">

                        {action === 'refer' && <Refer_A_Friend />}
                    </div>
                </div>
            </div>
        </>
