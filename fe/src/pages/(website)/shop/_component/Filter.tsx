    ...
    return (
        <div className="lg:block hidden py-3 mt-0.5">
            ...
            <section className="flex flex-col pt-[47px] pb-6">
                ...
                <ul className="*:gap-y-3 *:gap-x-3.5 *:tracking-[1px] pt-2.5 pb-1.5 *:flex *:items-center *:my-[9px] border-b">
                    <li>
                        ...
                        <label htmlFor="sale1" className="relative sale2 before:w-5 before:h-5 before:border active:before:border-[6px] before:top-[10%] before:left-[-90%] active:before:border-[#17AF26] before:rounded-[50%] before:absolute">Sale</label>
                        <span className="text-[#9D9EA2] font-light ml-[7px]">12</span>
                    </li>
                    <li><input id="sale" className="w-[20px] h-[20px] accent-[#17AF26]" type="radio" /><label htmlFor="sale">Sale</label>
                        <span className="text-[#9D9EA2] font-light ml-[7px]">12</span>
                    </li>
                    <li><input id="sale" className="w-[20px] h-[20px] accent-[#17AF26]" type="radio" /><label htmlFor="sale">Sale</label>
                        <span className="text-[#9D9EA2] font-light ml-[7px]">12</span>
            ...
            <section className="flex flex-col pr-7 pb-6 border-b">
                ...
                <button className="w-[103px] mt-6 h-[40px] rounded-[1000px] bg-[#17AF26] text-white">Apply</button>
            </section>
            {/* order */}
            <section className="flex flex-col py-6">
                ...
                <ul className="*:gap-3 py-2 *:flex *:items-center *:my-[9px] border-b">
                    <li> <input className="w-[20px] h-[20px]" type="radio" /> Sale</li>
                    <li> <input className="w-[20px] h-[20px]" type="radio" /> Sale</li>
                    <li> <input className="w-[20px] h-[20px]" type="radio" /> Sale</li>
                    <li> <input className="w-[20px] h-[20px]" type="radio" /> Sale</li>
                    <li> <input className="w-[20px] h-[20px]" type="radio" /> Sale</li>
            ...
            <section className="flex flex-col">
                ...
                <ul className="*:gap-3 pb-2 *:flex *:items-center *:my-[18px] border-b">
                    <li> <input className="w-[20px] h-[20px]" type="checkbox" />
            ...
            {/* clear filters */}
            <button className="bg-[#F3FBF4] rounded-[100px] text-[14px] leading-[21px] text-[#17AF26] mt-5 h-10 px-8">Clear Filters</button>
        </div>
